...
export const useSocketTicker = (enabled = false) => {
    ...
    useEffect(() => {
        ...
        const client = new Client({
            ...
            onConnect: () => {
                console.log("Safi connectina a l'3chir... 🔗");
                ...
                client.subscribe('/topic/ticker/BTC', (message) => {
                    ...
                    const bucketTime = Math.floor(serverTime / TIMEFRAME_SECONDS) * TIMEFRAME_SECONDS;
                    ...
                    if (historyRef.current.length === 0) {
                        const fakeHistory = generateBackwardsHistory(bucketTime, price, TIMEFRAME_SECONDS);
